...
const EXAMPLE_DATA: Contato[] = [
  {codigo: 1, nome: 'Hydrogen', sobreNome: "gomes", cpf: "63076965085", email: "g@gmail.com", endereco:"tttt", telefone:"8767969879"},
];
 ...
 */
export class ContatoRead2DataSource extends DataSource<Contato> {
